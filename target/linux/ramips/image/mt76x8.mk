...
define Device/Silbo_RC44
  DTS := Silbo_RC44
  IMAGE_SIZE := $(ralink_default_fw_size_16M)
  SUPPORTED_DEVICES := Silbo_RC44 
  DEVICE_TITLE := Silbo RC44
  DEVICE_PACKAGES:= kmod-usb2 kmod-usb-ohci uboot-envtools
endef
TARGET_DEVICES += Silbo_RC44


define Device/Silbo-RC44-EC25E
  DTS := Silbo-RC44-EC25E
  IMAGE_SIZE := $(ralink_default_fw_size_32M)
  SUPPORTED_DEVICES := Silbo-RC44-EC25E 
  DEVICE_TITLE := Silbo RC44 EC25E
  DEVICE_PACKAGES:= kmod-usb2 kmod-usb-ohci uboot-envtools
endef
TARGET_DEVICES += Silbo-RC44-EC25E

define Device/Silbo-RC44-EC200A
  DTS := Silbo-RC44-EC200A
  IMAGE_SIZE := $(ralink_default_fw_size_16M)
  SUPPORTED_DEVICES := Silbo-RC44-EC200A 
  DEVICE_TITLE := Silbo RC44 EC200A
  DEVICE_PACKAGES:= kmod-usb2 kmod-usb-ohci uboot-envtools
endef
...
define Device/Silbo_IA44-B_GW
  DTS := Silbo_IA44-B_GW
  IMAGE_SIZE := $(ralink_default_fw_size_32M)
  SUPPORTED_DEVICES := Silbo_IA44-B_GW 
  DEVICE_TITLE := Silbo IA44-B_GW
  DEVICE_PACKAGES:= kmod-usb2 kmod-usb-ohci uboot-envtools
endef
TARGET_DEVICES += Silbo_IA44-B_GW

define Device/Silbo_IA44-C_GW
  DTS := Silbo_IA44-C_GW
  IMAGE_SIZE := $(ralink_default_fw_size_32M)
  SUPPORTED_DEVICES := Silbo_IA44-C_GW 
  DEVICE_TITLE := Silbo IA44-C_GW
  DEVICE_PACKAGES:= kmod-usb2 kmod-usb-ohci uboot-envtools
endef
...
define Device/Silbo_IAB44-B_GW
  DTS := Silbo_IAB44-B_GW
  IMAGE_SIZE := $(ralink_default_fw_size_32M)
  SUPPORTED_DEVICES := Silbo_IAB44-B_GW 
  DEVICE_TITLE := Silbo IAB44-B_GW
  DEVICE_PACKAGES:= kmod-usb2 kmod-usb-ohci uboot-envtools
endef
...
define Device/Silbo_IC44_GW
  DTS := Silbo_IC44_GW
  IMAGE_SIZE := $(ralink_default_fw_size_32M)
  SUPPORTED_DEVICES := Silbo_IC44_GW 
  DEVICE_TITLE := Silbo IC44_GW
  DEVICE_PACKAGES:= kmod-usb2 kmod-usb-ohci uboot-envtools
endef
TARGET_DEVICES += Silbo_IC44_GW

define Device/Silbo_GD44-A_GW
  DTS := Silbo_GD44-A_GW
  IMAGE_SIZE := $(ralink_default_fw_size_32M)
  SUPPORTED_DEVICES := Silbo_GD44-A_GW 
  DEVICE_TITLE := Silbo_GD44-A_GW
  DEVICE_PACKAGES:= kmod-usb2 kmod-usb-ohci uboot-envtools
endef
